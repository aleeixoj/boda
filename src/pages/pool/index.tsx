    ...
    >
      ...
      >
        ...
        <Flex direction={'column'}>
          ...
          >
            ...
            <Text color={'cyan.600'}>
              ...
              sua presença nesse dia. Sabemos que está em cima da hora, mas não
              queríamos deixar passar em branco esse dia tão especial. Será uma
              festa simples, mas preparada com muito carinho e queremos estar
              rodeados de pessoas importantes.
            </Text>
          </Box>
          ...
          >
            ...
            <Text color={'purple.600'}>
              ...
              parquinho para as crianças. Então venha com a roupa que se sentir
              confortável.
            </Text>
          </Box>
          ...
          >
            ...
            <Text color={'teal.300'}>
              Na passagem da gravata e sapatinho, teremos um sorteio com brinde.
            </Text>
          </Box>
        </Flex>
        ...
        <Flex direction={'column'}>
          ...
          >
            <Text color={'red.600'}>
              Precisamos que a sua presença seja confirmada até dia 21/03/2022,
              para que possamos nos organizar. Após esse prazo o link de
              confirmação não estará mais disponível.
            </Text>
          </Box>
        </Flex>
        <Spacer p="3" />
